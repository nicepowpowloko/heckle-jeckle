...
<body>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Chicha.jpg">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Chicha 2.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Chicha 3.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Chicha 4.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Chicha 5.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Chicha 6.png">
            </div>
          </div>
        </div>
        <!-- Add Pagination -->
  ...
  <div class="swiper swiper-container-main">
    <div class="swiper-wrapper">
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Chicha.jpg"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Chicha 2.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Chicha 3.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Chicha 4.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Chicha 5.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Chicha 6.png"></div>
    </div>
    <!-- Add Pagination -->
...
<div class="swiper gallery-thumbs">
	<div class="swiper-wrapper">
	 	...
	 	<img src="../Images/Chicha.jpg">  
            ...
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Chicha 2.png">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Chicha 3.png">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Chicha 4.png">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Chicha 5.png">  
            </div> 
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Chicha 6.png">  
 	</div>
</div>	

	<h1>Description</h1>
	<p> Ensembles / kits de narguilé portables
        <br>
Un produit conçu pour les personnes qui souhaitent fumer en voyage, pas besoin d'emporter le kit narguilé avec vous en voyage.
<br>
Ce narguilé de qualité de 19,7 pouces est un exemple de fabrication moderne appliquée à une tradition ancienne.
<br>
Il est facile à assembler/démonter, à nettoyer et à ranger, ce qui en fait le narguilé parfait à emporter partout.
<br>
Il fonctionne aussi bien que ses homologues plus grands et est très populaire auprès des nouveaux connaisseurs de narguilé et des connaisseurs chevronnés du narguilé du monde entier.
Conçu pour des années et des années de plaisir pour le narguilé.
<br>
Comment utiliser
<br>
Mettez cet ensemble sur la bouteille (vous devez mettre de l'eau dans la bouteille).
<br>
Mettez le tabac dans les bols.
<br>
Placez le papier d'aluminium sur les bols.
<br>
Brûlez les charbons et placez-les sur le papier d'aluminium. </p>
