...
<body>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Thé 1.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Thé 2.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Thé 3.png">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Thé 4.png">
            </div>
          </div>
  ...
  <div class="swiper swiper-container-main">
    <div class="swiper-wrapper">
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Thé 1.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Thé 2.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Thé 3.png"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Thé 4.png"></div>
...
<div class="swiper gallery-thumbs">
	<div class="swiper-wrapper">
	 	...
	 	<img src="../Images/Thé 1.png">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Thé 2.png">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Thé 3.png">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Thé 4.png">  
            </div>
    
</div>	

	<h1>Description</h1>
	<p>Dimensions du produit (L x l x h): 20.5 x 10.5 x 7 cm; 500 grammes
    <br>
    Is Discontinued By Manufacturer: Non
    <br>
    Poids net du produit: 500 Grammes
    <br>
    Unités: 500 gramme
    <br>
    Marque: Caykur
