...
<head>
    ...
    <title>BABOUCHES MAROCAINE TRADITIONNELLE</title>
</head>
<body>
<?php
...
<body>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Babouche 1.jpg">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Babouche 2.jpg">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Babouche 3.jpg">
            </div>
          </div>
        </div>
        <!-- Add Pagination -->
  ...
  <div class="swiper swiper-container-main">
    <div class="swiper-wrapper">
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Babouche 1.jpg"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Babouche 2.jpg"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Babouche 3.jpg"></div>
    </div>
    <!-- Add Pagination -->
...
<div class="swiper gallery-thumbs">
	<div class="swiper-wrapper">
	 	...
	 	<img src="../Images/Babouche 1.jpg">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Babouche 2.jpg">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Babouche 3.jpg">  
            </div>
        
</div>	

	<h1>Description</h1>
    Babouche Marocaine Pantoufles Chaussures Femme En Cuir Marocain À La Main Arabe
    <br>
    Référence 1510191101
    <br>
    État : Nouveau produit
    <br>
    Babouches Marocaine traditionnelle, en cuir véritable et travaillé entièrement à la main par des artisans locaux
    <br>
    Adaptable à tout type de vêtements
