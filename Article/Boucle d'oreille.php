...
<body>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Oreille 1.jpg">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Oreille 2.webp">
            </div>
          </div>
          <div class="swiper-slide swiper-slide-modal">
            <div class="swiper-zoom-container">
              <img class="swiper-lazy swiper-lazy-modal" data-src="../Images/Oreille 3.webp">
            </div>
          </div>
  ...
  <div class="swiper swiper-container-main">
    <div class="swiper-wrapper">
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Oreille 1.jpg"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Oreille 2.webp"></div>
      <div class="swiper-slide minimum-height"><img class="swiper-slide-img" src="../Images/Oreille 3.webp"></div>
...
<div class="swiper gallery-thumbs">
	<div class="swiper-wrapper">
	 	...
	 	<img src="../Images/Oreille 1.jpg">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Oreille 2.webp">  
            </div>
            <div class="swiper-slide swiper-slide-thumbs">     
	 	<img src="../Images/Oreille 3.webp">  
            </div>
     
</div>	

	<h1>Description</h1>
	<p>Maroc – Ancienne paire de boucles d’oreilles berbère en argent avec émail et verroterie bleue - Tiznit Région
    <br>
    Début 20ème siècle
    <br>
    Hauteur: 8cm
